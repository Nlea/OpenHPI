...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "OpenHPI";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "OpenHPI.war")
            ...
            .addPackages(false, "Camunda.OpenHPI") // not recursive to skip package 'nonarquillian'
